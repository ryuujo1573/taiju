/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 4348c783c0b2b1a7fc01f3b512d6c6b2)
...
declare namespace Cloudflare {
  interface Env {
    ...
    TAIJU_ENGINE: AnalyticsEngineDataset;
    IMAGES: ImagesBinding;
    ASSETS: Fetcher;
    API_KEY: string;
    WORKER_SELF_REFERENCE: Fetcher /* taiju */;
  }
}
...
interface Disposable {
  readonly __disposableBrand?: never;
}
/**
...
declare namespace Cloudflare {
  ...
  interface Env {
    readonly __cloudflareEnvBrand?: never;
  }
  ...
  interface GlobalProps {
    readonly __cloudflareGlobalPropsBrand?: never;
  }
